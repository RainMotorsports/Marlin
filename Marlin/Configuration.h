 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {  94.139704, 94.139704, 400, 96.275201870 } //ReplicatorG dervived values, Rounded to match FF Creator Pro example
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 65, 10, 65, 10 } // (mm) Left, Front, Right, Back insets
